...
Generate MongoDB JSON documents from MSE engine steps, using:
...
class MongoDB:
    ...
    def main(self):
        output_dir = os.path.join(PROJECT_ROOT, "databases", "output", "mongo_output")
        ...
        for _ in range(steps):
            ...
            filename = os.path.join(output_dir, f"mongo_day_{t:03}.json")
